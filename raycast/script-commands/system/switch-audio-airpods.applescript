...
# @raycast.title Switch Audio to Airpods
# @raycast.mode silent
...
# @raycast.description Switch audio output to AirPods.

set asrc to "merle airpods"
...
do shell script "echo Audio switched to AirPods"